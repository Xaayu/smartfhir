...
function JsonBlock({ data, maxHeight = 320 }) {
...
function StatPill({ label, value, color = C.text }) {
  return (
    <div style={{
      ...
      <div style={{ color: C.muted, fontSize: 11, marginTop: 3, textTransform: "uppercase", letterSpacing: "0.06em" }}>
        {label}
      </div>
    </div>
  );
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <a href="/phi/modes" style={{
            background: C.surface, border: `1px solid ${C.border}`,
            borderRadius: 8, padding: "7px 14px",
            color: C.dim, fontSize: 13, textDecoration: "none",
      ...
      <div style={{ padding: "24px 32px", maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 12, color: C.muted, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              {deidentifiedData ? (
                <>
                  ...
                  <JsonBlock data={deidentifiedData} maxHeight={380} />
